...
// helper functions
var moveDrag = function moveDrag(startEvent, moveEvent) {
    $drag.css({
...
var currentOverArea$ = _Rx2.default.Observable.merge(_Rx2.default.Observable.fromEvent($dropAreas, "mouseover").map(function (ev) {
    return (0, _jquery2.default)(ev.target);
}), _Rx2.default.Observable.fromEvent($dropAreas, "mouseout").map(function (ev) {
    return null;
}));

// handle drag & drop
var drops$ = beginDrag$.do(function (ev) {
    ev.preventDefault();
